...
This is an R package used to estimate lifetime risk of developing or dying from cancer using Population-Based Cancer Registry data.

## Installation

You can install the development version of ltRISK from [GitHub](https://github.com/) with:
...
Calculate the cumulative mortality risk with the predefined upper limit age of 74 years.
...
You can also calculate the cumulative incidence risk with the predefined upper limit age of 74 years.
